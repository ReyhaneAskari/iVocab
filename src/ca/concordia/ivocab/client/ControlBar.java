...
public class ControlBar extends Widget {
  ...
  public static class Controls {
    ...
    public void addSearchField(String cssClassName, EventListener action) {
        DivElement searchBox = Document.get().createDivElement();       
        DivElement control = Document.get().createElement("input").cast();
        control.setAttribute("id", "searchword");
        control.setId("searchword");
        DivElement search = createLabelledFieldGroup("Search:", control);
    ...
    private DivElement createLabelledFieldGroup(String labelText, Element field) {
        ...
        fieldGroup.setClassName(resources.controlBarCss().fieldGroup());
 
        DivElement label = Document.get().createDivElement();
        label.setInnerText(labelText);
 
        label.setClassName(resources.controlBarCss().label());
        field.setClassName(resources.controlBarCss().field());
